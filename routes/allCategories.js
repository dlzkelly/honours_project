...
router.get('/cameras_photography/telescopes_binoculars', function(req, res, next) {
    res.render('productBinoculars', {category: "Cameras & Photography", subcategory: "Telescopes & Binocolulars"});
}); 
router.get('/computers_tablets_networking/printers_scanners_supplies', function(req, res, next) {
    res.render('productScanner', {category: "Computers, Tablets & Networking", subcategory: "Printers, Scanners & Supplies"});
});
router.get('/pet_supplies/birds', function(req, res, next) {
    res.render('productCage' , {category: "Pet Supplies", subcategory: "Birds"});
});
router.get('/music/cassettes', function(req, res, next) {
    res.render('productCassette', {category: "Music", subcategory: "Cassettes"});
});
router.get('/toys_games/jigsaws_puzzles', function(req, res, next) {
    res.render('productJigsaw', {category: "Toys & Games", subcategory: "Jigsaws & Puzzles"});
});
router.get('/sporting_goods/scooters', function(req, res, next) {
    res.render('productScooter', {category: "Sporting Goods", subcategory: "Scooters"});
});
router.get('/mobile_phones_communication/smart_watches', function(req, res, next) {
    res.render('productSmartwatch', {category: "Mobile Phones & Communication", subcategory: "Smart Watches"});
});
router.get('/health_beauty/e_cigarettes_vapes_accs', function(req, res, next) {
    res.render('productVape', {category: "Health & Beauty", subcategory: "E-Cigarettes & Vapes"});
});
